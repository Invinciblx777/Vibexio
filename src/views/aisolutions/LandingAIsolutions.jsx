    ...
    return (
        <>
            <SEO
                ...
                description="From predictive analytics to generative AI, Vibexio helps businesses harness artificial intelligence to automate, optimize, and accelerate growth."
                canonical="https://vibexio.ai/aisolutions"
            />
            <div className="mt-20 bg-[#BECCDD] border-[0.5px] border-[#5B7C9980] relative overflow-hidden 
                ...
                <div className="absolute inset-0 transform scale-90 md:scale-90 lg:scale-100 origin-center">
                    ...
                    <img src={img2} className="absolute top-45 md:top-54 lg:top-60 xl:top-70 left-0 md:left-0 lg:left-14 xl:left-[100px] 
                    ...
                    {/* Top Right Images */}
                    <img src={img4} className="absolute top-45 md:top-10 lg:top-25 right-0 md:right-20 lg:right-[120px] xl:right-[200px] 
                    w-[70px] h-[70px]  md:w-[90px] md:h-[90px] lg:w-[90px] lg:h-[90px] rounded-xl" />
                ...
                <div className="flex flex-col items-center justify-center px-4 xs:px-6 sm:px-8 lg:px-0 z-10 relative">
                    ...
                    mb-3 xs:mb-4 sm:mb-5 md:mb-6 lg:mb-0">
                        Transform Operations with the <span className="text-white">Power of Intelligence</span> <br />
                    </h2>
                    ...
                    lg:mt-8 xl:mt-10 mt-2 xs:mt-3 sm:mt-4">
                        From predictive analytics to generative AI, Vibexio helps businesses harness artificial intelligence to automate, optimize, and accelerate growth</p>
