...
import LightBulbIcon from "../../components/icons/itsolutions/LightBulbIcon.jsx";

const steps = [
    {
        icon: PlayCircleIcon,
        title: "Discovery",
        desc: "Understand your users and business model.",
    },
    {
        icon: LightBulbIcon,
        title: "Strategy",
        desc: "Define the architecture and experience flow.",
    },
    {
        icon: FaceIcon,
        title: "Design",
        desc: " Craft UI/UX that inspires interaction.",
    },
    {
    ...
    },
    {
        ...
        desc: "Test, deploy, and monitor performance.",
    },
];

const OurDigitalExcellence = () => {
    return (
...
export default OurDigitalExcellence; 